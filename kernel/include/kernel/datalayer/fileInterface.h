...
int fileInterface_readFile (file_t *file, char *buffer, nvmos_size_t length);

int fileInterface_rewindFile (file_t *file, nvmos_size_t positionFromStart);

int fileInterface_writeFile (file_t *file, const char* source, nvmos_size_t length);

int fileInterface_mapFileToProcess (file_t *file, process_t *process, uptr_t position);

nvmos_size_t fileInterface_getFileSize (file_t *file);

int fileInterface_resizeFile (file_t *file, nvmos_size_t newSize);
