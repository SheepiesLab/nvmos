...
int datalayer_allocatePageToProcess (process_t *process, size_t size, kptr_t *allocationAddress);

int datalayer_freePageFromProcess (process_t *process, kptr_t allocationAddress);
