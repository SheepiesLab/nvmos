...
KernelSection *ksection_getKsections()
{
	...
	ksects[KSECTION_SECTION_TEXT].addr = (nvmos_pointer_t)&__start_text;
	ksects[KSECTION_SECTION_TEXT].len =
		(nvmos_pointer_t)&__end_text - (nvmos_pointer_t)&__start_text;

	ksects[KSECTION_SECTION_RODATA].section = KSECTION_SECTION_RODATA;
	ksects[KSECTION_SECTION_RODATA].addr = (nvmos_pointer_t)&__start_rodata;
	ksects[KSECTION_SECTION_RODATA].len =
		(nvmos_pointer_t)&__end_rodata - (nvmos_pointer_t)&__start_rodata;

	ksects[KSECTION_SECTION_DATA].section = KSECTION_SECTION_DATA;
	ksects[KSECTION_SECTION_DATA].addr = (nvmos_pointer_t)&__start_data;
	ksects[KSECTION_SECTION_DATA].len =
		(nvmos_pointer_t)&__end_data - (nvmos_pointer_t)&__start_data;

	ksects[KSECTION_SECTION_TSS].section = KSECTION_SECTION_TSS;
	ksects[KSECTION_SECTION_TSS].addr = (nvmos_pointer_t)&__start_tss;
	ksects[KSECTION_SECTION_TSS].len =
		(nvmos_pointer_t)&__end_tss - (nvmos_pointer_t)&__start_tss;

	ksects[KSECTION_SECTION_BSS].section = KSECTION_SECTION_BSS;
	ksects[KSECTION_SECTION_BSS].addr = (nvmos_pointer_t)&__start_bss;
	ksects[KSECTION_SECTION_BSS].len =
		(nvmos_pointer_t)&__end_bss - (nvmos_pointer_t)&__start_bss;

	ksects[KSECTION_SECTION_HEAP].section = KSECTION_SECTION_HEAP;
	ksects[KSECTION_SECTION_HEAP].addr = (nvmos_pointer_t)&__start_heap;
	ksects[KSECTION_SECTION_HEAP].len =
		(nvmos_pointer_t)&__end_heap - (nvmos_pointer_t)&__start_heap;
